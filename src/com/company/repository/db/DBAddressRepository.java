...
public class DBAddressRepository extends DBAbstractRepository implements AddressRepository {
    ...
    public static void main(String[] args) throws SQLException {
        DBAddressRepository dbAddressRepository = new DBAddressRepository();
//        dbAddressRepository.saveAddress(new Address("malina 30"));
        dbAddressRepository.saveAddress(new Address("truda 40"));

//        System.out.println(dbAddressRepository.updateStreetNameById("duba 56", 2));

        System.out.println(Arrays.toString(dbAddressRepository.getAllAddresses()));

        dbAddressRepository.deleteAddressById(2);
