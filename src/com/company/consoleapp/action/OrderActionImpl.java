...
public class OrderActionImpl implements OrderAction {
    ...
    public OrderActionImpl(Writer writer, Reader reader, OrderService orderService, StoreService storeService, BookService bookService, UserService userService, AddressService addressService) {
        this.writer = writer;
        this.reader = reader;
