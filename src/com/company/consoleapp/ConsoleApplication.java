...
//    }
//
//    private File authorFile = new File(properties.getProperty("file.authors"));
//    private File bookFile = new File(properties.getProperty("file.books"));
...
//    private OrderRepository orderRepository = new FileOrderRepository(orderFile, userFile, roleFile, addressFile, storeFile, authorFile, bookFile, statusFile);
    ...
    private AuthorRepository authorRepository = new DBAuthorRepository();
    ...
    private OrderRepository orderRepository = new DBOrderRepository();
    ...
    private AuthorAction authorAction = new AuthorActionImpl(writer, reader, authorService);
    private BookAction bookAction = new BookActionImpl(bookService, writer, reader, authorService);
    private AddressAction addressAction = new AddressActionImpl(writer, reader, addressService);
    private StoreAction storeAction = new StoreActionImpl(writer, reader, storeService, addressService);
    private UserAction userAction = new UserActionImpl(writer, reader, userService);
    private OrderAction orderAction = new OrderActionImpl(writer, reader, orderService, storeService, bookService, userService, addressService);
